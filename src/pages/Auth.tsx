...
export const Auth = () => {
  ...
  if (loading) {
    return <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/20 via-primary/10 to-primary-light/20">
        <LoadingSpinner size="lg" text="Carregando..." />
      </div>;
  }
  return <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary via-primary-light to-primary-dark relative overflow-hidden">
          ...
          <CardHeader className="text-center pb-8">
            ...
            <div className="flex justify-center mb-6">
              <div className="relative">
                ...
                <img src={logo} alt="Poderalize" className="w-20 h-20 rounded-full relative z-10 shadow-lg border-4 border-white" />
              </div>
            </div>
            ...
            <div className="w-full space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                {isLogin ? <>
                    ...
                    <span className="text-primary font-medium cursor-pointer hover:underline" onClick={() => setIsLogin(false)}>
                      "Cadastrar"
                    </span>
                  </> : <>
